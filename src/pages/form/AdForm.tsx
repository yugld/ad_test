...
function AdForm() {
  ...
  const onSubmit: SubmitHandler<AdSchema> = (data) => {
    createItem(data);
    navigate('/list');
  };
  ...
  return (
    ...
    >
      <Stack sx={{ gap: 2 }}>
        <Typography variant="h6">Создать объявление</Typography>
        <TextField
          {...register('name')}
          label="Название"
        ...
        />
        <TextField {...register('image')} label="image URL (optional)" />
